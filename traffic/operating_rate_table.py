...
OPERATING_RATE_DUAL_MBPS: dict[str, list[float]] = {
    ...
    "HT160": [144, 288, 432, 576, 864, 1152, 1297, 1441, 1729, 1921, 2161, 2401],
}
...
OPERATING_RATE_SINGLE_MBPS: dict[str, list[float]] = {
    ...
    "HT160": [72, 144, 216, 288, 432, 576, 648, 720, 864, 960, 1080, 1201],
}
...
MIN_SNR_DB: dict[str, list[float]] = {
    ...
    "HT160": [17, 20, 23, 25, 28, 31, 33, 37, 41, 44, 46, 47],
}
