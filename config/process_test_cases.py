...
OFFICIAL_PROCESS_TEST_CASES: tuple[ProcessTestCase, ...] = (
    ...
    ProcessTestCase(
        "PROCESS_16",
        "Kill Single Process",
        "Kill one randomly-chosen running monitored service via SIGKILL",
    ...
    ProcessTestCase(
        ...
        "Batch SIGKILL all monitored services at once; verify each respawns in parallel",
    ...
    ProcessTestCase(
        ...
        "Batch SIGKILL all critical services at once (rpcd/network/dnsmasq/sshd/log/uhttpd/snmpd/odhcpd)",
        "Each critical process restarts automatically; device remains stable; restart logged",
        "Negative",
        "CPE",
        "CPE-TC-SW-41",
        ("crash",),
    ...
    ProcessTestCase(
        "PROCESS_19",
        "Kill All Processes Under Load",
        "Run high CPU stress, then batch SIGKILL all monitored services at once",
        "Each process restarts promptly despite load; restart logged correctly",
        "Stress",
        "CPE",
        "CPE-TC-SW-41",
        ("crash", "stress"),
