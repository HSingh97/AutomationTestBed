...
# 2.4G_RADIO plan — scan lab PC near CPE for hidden mgmt SSID visibility.
RADIO_24_SCAN_DEFAULTS = {
    "SCAN_PC_IP": "10.0.150.7",
    "SCAN_PC_PASSWORD": "senao1234#",
    "CPE_MGMT_HIDDEN_SSID": "KWDEJPOQ",
    "CPE_MGMT_HIDDEN_PASSWORD": "xvxsbulj",
    "CPE_MGMT_WRONG_PASSWORD": "WrongAutoTestKey!99",
    "SCAN_SETTLE_S": 4,
    "SCAN_TIMEOUT_S": 45,
    "CONNECT_SETTLE_S": 10,
    "CPE_MGMT_IP": "169.254.254.1",
    "INTERNET_PROBE_HOST": "8.8.8.8",
    "HIDDEN_TOGGLE_ATTEMPTS": 10,
    "CPE_RADIO_24_IDX": 0,
    "RADIO_TOGGLE_SETTLE_S": 3,
    "LAB_PC_FLUSH_ATTEMPTS": 3,
    "CPE_WIFI_RELOAD_WAIT_S": 8,
    "CPE_REBOOT_WAIT_S": 180,
    "CPE_REBOOT_BOOT_S": 90,
    "LINK_UP_TIMEOUT_S": 180,
    "CONNECT_RETRY_ATTEMPTS": 3,
    "MGMT_AP_READY_WAIT_S": 12,
    "CPE_24G_IFACE": "ath0",
    "FW_FILE": "Senao-UBR650-xxx-0.0.0.730-single.tgz",
    "FW_DIR": "/tftpboot",
    "FW_UPLOAD_TIMEOUT_S": 900,
    "FW_UPGRADE_WAIT_S": 1200,
    "DHCP_EXPECTED_CLIENT_IP": "169.254.254.100",
    "DHCP_POOL_PREFIX": "169.254.",
    "DHCP_NO_IP_WAIT_S": 25,
    "WIFI_TOGGLE_CYCLES": 25,
    "WIFI_TOGGLE_GAP_S": 0.15,
    "WIFI_AUTORECONNECT_WAIT_S": 120,
    "SCAN_PC_WIFI_REBOOT_WAIT_S": 180,
    "SCAN_PC_WIFI_RECOVERY_ATTEMPTS": 4,
    "CPE_AP_RECOVERY_ATTEMPTS": 2,
    "BOOT_SCAN_POLL_S": 5,
    "BOOT_EARLY_SCAN_MAX_S": 90,
    "DHCP_LOG_PATTERNS": [
        r"DHCPACK",
        r"dhcp.*lease",
        r"169\.254\.254\.100",
...
WIRELESS_SECURITY_TEST_VALUES = {
    "WPA2_ENCRYPTION_GUI": "AES-256",
    "WPA2_ENCRYPTION_UCI": "psk2+ccmp-256",
    "INSECURE_ENCRYPTION_GUI": "None",
    "INSECURE_ENCRYPTION_UCI": "none",
    "INVALID_CPE_PASSPHRASE": "WrongAutoTestKey!99",
    ...
    "LINK_DOWN_TIMEOUT_S": 90,
    "LINK_UP_TIMEOUT_S": 120,
    "LINK_RESTORE_MAX_S": 240,
    "LINK_UPTIME_MAX_S": 120,
    "LINK_STABILITY_MONITOR_S": 300,
    "LINK_STABILITY_INTERVAL_S": 15,
    "CPE_REBOOT_WAIT_S": 120,
    "LOG_SETTLE_S": 20,
}
...
PERFORMANCE_DEFAULTS = {
    ...
    "require_all_su_for_bandwidth": True,
